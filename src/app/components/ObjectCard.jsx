...
const ObjectCard = ({ object }) => {
  ...
  return (
    <div
      className="flex flex-col h-max w-max p-8 bg-white rounded-2xl shadow-xl hover:bg-blue-200 duration-500"
    ...
    >
      ...
      {expanded ? (
        <div className="flex flex-col bg-white transition-transform rounded-2xl p-4 text-xl text-black">
